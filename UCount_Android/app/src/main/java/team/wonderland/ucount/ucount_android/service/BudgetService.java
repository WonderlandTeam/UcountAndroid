...
public interface BudgetService {
    ...
    BudgetInfoJson getBudget(@Path Long budget_id);
    ...
    List<BudgetInfoJson> getBudgetsByUser(@Path String username, @Path String date);
     ...
     */
    @Post("/budgets/")
    Long addBudget(@Body BudgetAddJson budgetAddJson);
